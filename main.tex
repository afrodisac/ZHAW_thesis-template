...
\thesistitle{Flood Modeling with Neural Cellular Automata}             % Thesis title,              command: \ttitle
...
\include{Appendices/DeclarationOfAuthorship}
\include{Appendices/DeclarationOfConscent}
\include{Appendices/NFOMastersThesisTopicFormandRegistration}
%----------------------------------------------------------------------------------------
% BIBLIOGRAPHY
